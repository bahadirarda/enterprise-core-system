...
export function LoginForm() {
  ...
  const getRedirectUrl = (role?: string) => {
    ...
    const portalUrl = (typeof window !== 'undefined' && process.env.NEXT_PUBLIC_PORTAL_URL) || 'http://localhost:4001'
    const hrmsUrl = (typeof window !== 'undefined' && process.env.NEXT_PUBLIC_HRMS_URL) || 'http://localhost:4002'
